...
namespace longtermcare
{
    public partial class Administration : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //datasource = longtermcare.HospitalConnect.ConnectionString.ReturnConnectionString(connection_id);
 ...
 /*
            ...
            */
            if (!IsPostBack)
            {
                if (Session["lbltabindx3"] != null && Session["lbltabindx3"].ToString() == "1")
                {
                    LinkBtnTabView1.Font.Bold = false;
                    LinkBtnTabView2.Font.Bold = true;
                    multiTabs.ActiveViewIndex = 1;
                }
                else if (Session["lbltabindx3"] != null && Session["lbltabindx3"].ToString() == "0")
                {
                ...
                {
                    Session["lbltabindx3"] = "0";
                    LinkBtnTabView1.Font.Bold = true;
                    LinkBtnTabView2.Font.Bold = false;
                    multiTabs.ActiveViewIndex = 0;
                }
                //Session.Contents.Remove("lbltabindx3");
                string master = "4";
        ...
        protected void ifhaveipno()
        {
            ...
            if (Session["lbltabindx3"].ToString() == "0")
            {
