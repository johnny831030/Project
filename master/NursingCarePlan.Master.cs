...
{
    public partial class NursingCarePlan : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            */
            ...
            if (!IsPostBack)
            {
                if (Session["lbltabindx1"] != null && Session["lbltabindx1"].ToString() == "1")
                {
                    LinkBtnTabView1.Font.Bold = false;
                    LinkBtnTabView2.Font.Bold = true;
                    multiTabs.ActiveViewIndex = 1;
                }
                else if (Session["lbltabindx1"] != null && Session["lbltabindx1"].ToString() == "0")
                {
                ...
                //Session.Contents.Remove("lbltabindx1");
                string master = "7";
        ...
        protected void dropRoomtype_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            command = "SELECT IP_INFORMATION.IP_NAME, ROOM.ROOM_BED, ROOM.ROOM_STATION FROM ROOM INNER JOIN IP_INFORMATION ON ROOM.IP_NO = IP_INFORMATION.IP_NO WHERE (ROOM.ROOM_AREA = @ROOM_AREA) AND (ROOM.ROOM_TYPE = @ROOM_TYPE) AND (ROOM.REPBED != 'N' OR ROOM.REPBED IS NULL) ORDER BY ROOM.ROOM_BED ASC, ROOM.ROOM_STATION ASC";
        ...
        protected void ifhaveipno()
        {
            ...
            if (Session["lbltabindx1"].ToString() == "0")
            {
        ...
        protected void gvwIPlist_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "IPNursingDashboard")//住民總表
            {
                ...
                Session["lbltabindx1"] = "0";
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "test", "location.href='../../FNursingDashboard_MNCP.aspx';", true);
            ...
            else if (e.CommandName == "IPNursingList")//病歷摘要
            {
                ...
                Session["lbltabindx1"] = "0";
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "test", "location.href='../../CareList_MNCP.aspx';", true);
            }
