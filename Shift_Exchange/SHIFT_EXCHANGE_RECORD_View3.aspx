<%@ Page Title="" Language="C#" MasterPageFile="~/NursingCarePlan.Master" AutoEventWireup="true"
    CodeBehind="SHIFT_EXCHANGE_RECORD_View3.aspx.cs" Inherits="longtermcare.NursingPlan.Shift_Exchange.SHIFT_EXCHANGE_RECORD_View3"
                        ...
                        <td class="style5">
                            ...
                            <p class="functionitem3">
                                <asp:LinkButton ID="LinkBtnGoToQView" runat="server" Font-Size="16px" ForeColor="#003300"
                                    OnClick="LinkBtnGoToQView_Click" Font-Bold="True">查詢/修改/刪除 護理交班</asp:LinkButton></p>
                        </td>
                        <td class="style6">
                            <div class="row1">
                            </div>
                ...
                <ContentTemplate>
                    ...
                    <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                        <asp:View ID="View1" runat="server">
                            ...
                            <br />
                            <asp:Button ID="btnPrint" runat="server" Height="24px" OnClick="btnPrint_Click" Text="列印查詢後的結果"
                        ...
                        <asp:View ID="View2" runat="server">
                            ...
                            <asp:Button ID="btn_DELET" runat="server" Height="24px" Text="刪除這一筆資料" UseSubmitBehavior="False"
                                OnClick="btn_DELET_Click" />
                            <asp:ConfirmButtonExtender ID="btnDELETE_ConfirmButtonExtender" runat="server" ConfirmText="確定要刪除這筆資料?"
                            ...
                            <asp:Panel ID="PanelData" runat="server" Enabled="False">
                                <table id="table1" border="1" style="width: 100%; color: Black;">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <br />
                                            <asp:TextBox ID="txtContent" runat="server" Height="100px" TextMode="MultiLine" Width="94%"></asp:TextBox>
                                            <br />
                                           ...
                                           onclick="btnSymbolsTools_Click" Text="符號表" />
                    ...
                    <tr align="center">
                        <td colspan="2" align="center">
                            <asp:Label ID="lblPhraseTitle" runat="server" ForeColor="Black" Font-Bold="true"
                                Font-Size="Medium" Font-Names="新細明體" Text="護理交班紀錄單常用片語"></asp:Label>
                        </td>
                        <td align="right">
