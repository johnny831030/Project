...
{
    public partial class SHIFT_EXCHANGE_RECORD_View3 : System.Web.UI.Page
    {
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //設定頁首頁尾
                //宣告檔案名稱
                string pdffilename = "NR_ShiftExchRecordList_" + sqlTransToIP_NO_NEW.getIP_NO_NEW(connection_id, ip_no) + ".pdf";
                ...
                Paragraph Title1 = new Paragraph(Session["hp_name"].ToString(), ChFont2);
                Title1.Alignment = 1;
                Paragraph Title2 = new Paragraph("護理交班記錄", ChFont2);
                 ...
                 * NAME 18
                 */
                    string r_date = sqlTime.DateAddSlash(dt.Rows[i]["A_DATE"].ToString());
                    string r_time = dt.Rows[i]["A_TIME"].ToString().Substring(0, 2) + ":" + dt.Rows[i]["A_TIME"].ToString().Substring(2, 2);
                    ...
                    string r_user = dt.Rows[i]["Name"].ToString();
        ...
        protected void ExecSearch(string rec_no)
        {
            ...
            //txtIPNAME.Text =dt_SelSERecord.Rows[0][15].ToString();
            txtIPAREA.Text = dt_SelSERecord.Rows[0][16].ToString();
            txtContent.Text = dt_SelSERecord.Rows[0][3].ToString();
            txtContent.Text = SpecialCharactersTransform.strtosc(dt_SelSERecord.Rows[0][3].ToString());
            dt_SelSERecord.Dispose();
            
            //if (Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"].ToString().Substring(0, 3) == "200")//只能查詢
            //{
            //    State3();
            //    Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"] = Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"].ToString().Substring(0, 3) + "3";
            //    //Session["tab_state_temp"] = Session["tab_state"].ToString() + "_SHIFT_EXCHANGE_RECORD_View3";
            //}
            //if (Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"].ToString().Substring(0, 3) == "201")//查修
            //{
            //    State4();
            //    Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"] = Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"].ToString().Substring(0, 3) + "4";
            //    //Session["tab_state_temp"] = Session["tab_state"].ToString() + "_SHIFT_EXCHANGE_RECORD_View3";
            //}
            //if (Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"].ToString().Substring(0, 3) == "202")//查刪
            //{
            //    State8();
            //    Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"] = Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"].ToString().Substring(0, 3) + "8";
            //    //Session["tab_state_temp"] = Session["tab_state"].ToString() + "_SHIFT_EXCHANGE_RECORD_View3";
            //}
            //if (Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"].ToString().Substring(0, 3) == "203")//查刪修
            //{
            //    State6();
            //    Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"] = Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"].ToString().Substring(0, 3) + "6";
            //    //Session["tab_state_temp"] = Session["tab_state"].ToString() + "_SHIFT_EXCHANGE_RECORD_View3";
            //}
        ...
        {
            State7();
            //if (Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"].ToString().Substring(0, 3) == "201")
            //{
            //    State5();
            //    Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"] = Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"].ToString().Substring(0, 3) + "5";
            //    //Session["tab_state_temp"] = Session["tab_state"].ToString() + "_SHIFT_EXCHANGE_RECORD_View3";
            //}
            //if (Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"].ToString().Substring(0, 3) == "203")
            //{
            //    State7();
            //    Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"] = Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"].ToString().Substring(0, 3) + "7";
            //    //Session["tab_state_temp"] = Session["tab_state"].ToString() + "_SHIFT_EXCHANGE_RECORD_View3";
            //}
        }
        ...
        protected void btn_DELET_Click(object sender, EventArgs e)
        {
            ...
            //if (Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"].ToString() == "2028")//查刪
            //{
            //    DeleteAfterFunction();
            //}
            //if (Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"].ToString() == "2036")//查刪修
            //{
            //    DeleteAfterFunction();
            //}
        }
        //刪除後的程序
        //private void DeleteAfterFunction()
        //{
        ...
        //        setDateControl();
        //        State1();
        //        Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"] = Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"].ToString().Substring(0, 3) + "1";
        //        //Session["tab_state_temp"] = Session["tab_state"].ToString() + "_SHIFT_EXCHANGE_RECORD_View3";
        //    }
        //    else
        //    {
        //        lblQueryResult.Text = "共" + GridView2.Rows.Count.ToString() + "筆";
        //        State2();
        //        Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"] = Session["tab_state_SHIFT_EXCHANGE_RECORD_View3"].ToString().Substring(0, 3) + "2";
        //        //Session["tab_state_temp"] = Session["tab_state"].ToString() + "_SHIFT_EXCHANGE_RECORD_View3";
        //    }
        //}
        ...
        protected void btnSAVE_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                /*
                string sdate = txtS_DATE.Text.Substring(0, 4) + txtS_DATE.Text.Substring(5, 2) + txtS_DATE.Text.Substring(8, 2);
                string edate = txtE_DATE.Text.Substring(0, 4) + txtE_DATE.Text.Substring(5, 2) + txtE_DATE.Text.Substring(8, 2);
        ...
        protected void btnPrintThisRecord_Click(object sender, EventArgs e)
        {
            ...
            string ipnno = sqlTransToIP_NO_NEW.getIP_NO_NEW(connection_id, ip_no);//dt_ip_info.Rows[0][4].ToString();
            try
            {
                Document Doc = new Document();
                MemoryStream Memory = new MemoryStream();
                ...
                string pdffilename = "NR_ShiftExchRecord_" + sqlTransToIP_NO_NEW.getIP_NO_NEW(connection_id, ip_no) + ".pdf";
                sqlPDFFooter.Headercontent(pdffilename);
                ...
                Doc.Add(Title);
                Paragraph Title2 = new Paragraph("護理交班紀錄單", ChFont2);
                Title2.Alignment = 1;//設定左右對齊 0:左 1:置中 2:右               
                PdfPTable title = new PdfPTable(5);
                title.SpacingBefore = 10f;
                title.WidthPercentage = 100;
                ...
                PdfPCell[] info = new PdfPCell[8];
                info[0] = new PdfPCell(new iTextSharp.text.Phrase("姓名：" + ip_name, ChFont));
                info[1] = new PdfPCell(new iTextSharp.text.Phrase("住民編號：" + ipnno, ChFont));
                info[2] = new PdfPCell(new iTextSharp.text.Phrase("床號：" + room_bed, ChFont));
                info[3] = new PdfPCell(new iTextSharp.text.Phrase("性別：" + ip_sex, ChFont));
                info[4] = new PdfPCell(new iTextSharp.text.Phrase("年齡：" + age, ChFont));
                info[5] = new PdfPCell(new iTextSharp.text.Phrase("列印人員：" + print_user, ChFont));
                ...
                Doc.Close();
                //Response.Clear();
                ////Response.AddHeader("Content-Disposition", "attachment; filename=ShiftExchangeRecord_NR_" + sqlTransToIP_NO_NEW.getIP_NO_NEW(connection_id, ip_no) + ".pdf");
        ...
        private DataTable BindGridView()
        {
            ...
            {
                dt = sqlShiftExchange.searchSHIFTE_RECORD(sstr_hid.Text, txt_sql.Text);
            }
            else if (txt_sqlcom.Text.Equals("2"))
            {
                dt = sqlShiftExchange.SearchLastSHIFTE_RECORD(sstr_hid.Text, txt_sql.Text, "1");
            }
            else if (txt_sqlcom.Text.Equals("3"))
            {
                dt = sqlShiftExchange.SearchLastSHIFTE_RECORD(sstr_hid.Text, txt_sql.Text, "5");
            }
