<%@ Page Title="" Language="C#" MasterPageFile="~/NursingCarePlan.Master" AutoEventWireup="true"
    CodeBehind="SHIFT_EXCHANGE_RECORD_View1.aspx.cs" Inherits="longtermcare.NursingPlan.Shift_Exchange.SHIFT_EXCHANGE_RECORD_View1"
                        ...
                        <td class="style7">
                            ...
                            <p class="functionitem5">
                                <asp:LinkButton ID="LinkBtnGoToAddNRView" runat="server" Font-Size="16px" ForeColor="#003300"
                                    OnClick="LinkBtnGoToAddNRView_Click" Font-Bold="True">新增護理交班</asp:LinkButton></p>
                        </td>
                        <td class="style5">
                            <div class="row1">
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="style33">
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                <asp:TextBox ID="txtShowDate" runat="server" onchange="txtShowDate_Changed();" MaxLength="10"></asp:TextBox>
                                                <asp:CalendarExtender ID="txtShowDate_CalendarExtender" runat="server" Enabled="True" Format="yyyy/MM/dd" TargetControlID="txtShowDate">
